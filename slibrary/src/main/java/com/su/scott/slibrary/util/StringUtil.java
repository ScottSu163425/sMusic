...
public class StringUtil {
    ...
    public static String toURLEncoded(String paramString) {
        ...
        try {
            ...
            L.e("toURLEncoded error:" + paramString, localException.getMessage());
        }
    ...
    public static String getURLDecoded(String paramString) {
        if (paramString == null || paramString.equals("")) {
            L.e("toURLDecoded error:" + paramString);
            return "";
        }
        ...
        try {
            ...
            L.e("toURLDecoded error:" + paramString, localException.getMessage());
        }
